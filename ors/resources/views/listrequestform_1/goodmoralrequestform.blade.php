...
<center>
  ...
  <div class="alert alert-danger w-50 m-0 m-auto" style="display:none" id="danger-acad-form" role="alert">
    ...
    <div class="containeer mb-5 mt-3 py-4 text-left">
        <div class="px-4">
            <form action="/submitGoodMoralForm" enctype="multipart/form-data" id="academic-form" method="POST">
                @csrf
                <div class="row">
                    <div class="col-25">
                    <label for="fname">Good Moral Character application form.</label>
                    </div>
                    <div class="col-75">
                    <label for="file"></label>
                    <input type="file" name="goodmoralform" multiple>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    <label for="lname">Request Letter</label>
                    </div>
                    <div class="col-75">
                    <label for="file"></label>
