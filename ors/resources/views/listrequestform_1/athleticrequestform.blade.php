...
<center>
  <div class="alert alert-success w-50 m-0 m-auto" style="display:none" id="success-ath-form" role="alert">
    Successfully sent a Request
  </div>
  <div class="alert alert-danger w-50 m-0 m-auto" style="display:none" id="danger-ath-form" role="alert">
    There was a problem upon updating status of Request
  </div>
    <div class="containeer mb-5 mt-3 py-4 text-left">
        <div class="px-4">
            <form action="/submitAthleticForm" enctype="multipart/form-data" id="athletic-form" method="POST">
                @csrf
                <div class="row">
                    <div class="col-25">
...
<script>
    $('#athletic-form').submit(function(e) {
        e.preventDefault();
        $.ajaxSetup({
            headers: {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                $('#success-ath-form').show();
                $("#success-ath-form").delay(3200).fadeOut(300);
            },error: function(){
              $('#danger-ath-form').show();
                $("#danger-ath-form").delay(3200).fadeOut(300);
            }
