...
<form action="/editForm" id="edit-academic-form" method="POST">
  @csrf
  <div class="modal" id="edit_academic_modal" tabindex="-1" role="dialog">
          ...
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              <h2 class="section-heading mb-4">
                <span class="section-heading-lower"><b>{{ $request_detail->name }}</b></span>
              </h2>
              <ul>
            ...
            <ul>
              ...
              @if(Auth::check())
                ...
                @else
                  <center> <a class="btn btn-primary mt-3" id="open_academic_form">Edit Request</a></center>
                @endif
              @endif
            </div>
          </div>
