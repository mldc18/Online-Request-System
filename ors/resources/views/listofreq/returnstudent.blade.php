...
<form action="/editForm" id="edit-return-form" method="POST">
  @csrf
  <div class="modal" id="edit_return_modal" tabindex="-1" role="dialog">
          ...
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              ...
              @if(Auth::check())
                ...
                @else
                <center> <a class="btn btn-primary mt-3" id="open_return_form">Edit Request</a></center>
                @endif
              @endif
            </div>
          </div>
