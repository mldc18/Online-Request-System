...
<form action="/editForm" id="edit-goodmoral-form" method="POST">
  @csrf
  <div class="modal" id="edit_goodmoral_modal" tabindex="-1" role="dialog">
          ...
          <div class="col-xl-9 col-lg-10 mx-auto">
            ...
            @if(Auth::check())
              @if(auth()->user()->user_type == 'student')
                <center> <a class="btn btn-primary mt-3" href="/goodmoralform">Make a Request</a></center>
              @else
                <center> <a class="btn btn-primary mt-3" id="open_goodmoral_form">Edit Request</a></center>
              @endif
            @endif
