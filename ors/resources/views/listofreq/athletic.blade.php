...
<form action="/editForm" id="edit-athletic-form" method="POST">
  @csrf
  <div class="modal" id="edit_athletic_modal" tabindex="-1" role="dialog">
            ...
            <div class="bg-faded rounded p-5">
              ...
              @if(Auth::check())
                @if(auth()->user()->user_type == 'student')
                  <center> <a class="btn btn-primary mt-3" href="/athleticform">Make a Request</a></center>
                @else
                  <center> <a class="btn btn-primary mt-3" id="open_athletic_form">Edit Request</a></center>
                @endif
              @endif
            </div>
          </div>
